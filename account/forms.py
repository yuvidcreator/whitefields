...
class UserLoginForm(AuthenticationForm):
    ...
    username = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control mb-3", "placeholder": "Registered Email ID", "id": "login-username"}
        )
    )
...
class PwdResetForm(PasswordResetForm):
    ...
    email = forms.EmailField(
        max_length=254,
        widget=forms.TextInput(
            attrs={"class": "form-control mb-3", "placeholder": "Enter Registered Email", "id": "form-email"}
        ),
    )
